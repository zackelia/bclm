...
> [!WARNING]
> BCLM does not work on macOS >= 15.0 due to new entitlement enforcement from the kernel that cannot be circumvented without disabling SIP. See discussion: https://github.com/zackelia/bclm/issues/49
